  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-0.5 flex-1 min-w-0">
        ...
        <span className="text-[12px] text-[#6b7280] leading-5">{description}</span>
      </div>
    </button>
  );
}
...
export default function LicenseQuestionPage() {
  ...
  const handleContinue = () => {
    if (choice === "yes") router.push("/dashboard");
    ...
    <AuthLayout>
      <div className="flex flex-col gap-7 lg:gap-8">
        ...
        <div className="flex flex-col gap-2">
          <h1 className="text-2xl lg:text-[32px] font-bold text-[#111827] leading-tight tracking-tight">
        ...
        <div className="flex flex-col gap-3">
          <RadioCard
            value="yes" selected={choice} onSelect={setChoice}
            title="Yes, I have one"
            description="I'll proceed directly to my dashboard. No verification needed."
          />
          <RadioCard
            value="no" selected={choice} onSelect={setChoice}
            title="No, I don't"
