    ...
    <KYCLayout activeStep="business-info">
      <div className="flex flex-col gap-8 lg:gap-10 items-center w-full max-w-[472px]">
        <div className="flex flex-col gap-2 items-center text-center w-full">
          <h1 className="text-xl lg:text-2xl font-medium text-[#2d2d2d] leading-8">Final Step!</h1>
        ...
        <div className="flex flex-col items-center gap-4 lg:gap-5 w-full">
          <div className="w-full bg-[#f5f5f5] rounded-2xl p-5 lg:p-8 flex flex-col items-center gap-4 lg:gap-5">
            <div className="w-14 h-14 lg:w-16 lg:h-16 rounded-2xl bg-white border border-[#eaeaea] flex items-center justify-center shadow-sm">
              <svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8 4C8 2.89543 8.89543 2 10 2H22L28 8V28C28 29.1046 27.1046 30 26 30H10C8.89543 30 8 29.1046 8 28V4Z" fill="#e5e7eb" stroke="#d1d5db" strokeWidth="1.5"/>
            ...
            <div className="flex flex-col gap-1.5 items-center text-center">
              <p className="text-sm font-medium text-[#2d2d2d] tracking-[0.14px]">Financial Information Required</p>
              <p className="text-xs text-[#5a5a5a] leading-5 tracking-[0.24px] max-w-[300px]">
                As part of our compliance process, we need to collect information about your source of funds and how you intend to use your account.
              </p>
            </div>

            <div className="flex flex-col gap-3 w-full max-w-[320px]">
              {["Source of funds & employment details", "Expected account usage & monthly volume"].map((item) => (
