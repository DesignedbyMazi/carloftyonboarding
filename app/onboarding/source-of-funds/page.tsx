    ...
    <FinalStepLayout activeStep="source-of-funds">
      <div className="flex flex-col gap-8 lg:gap-10 items-center w-full max-w-[472px]">
        <div className="flex flex-col gap-2 items-center text-center w-full">
          <h1 className="text-xl lg:text-2xl font-medium text-[#2d2d2d] leading-8">Source of Funds</h1>
        ...
        <div className="flex flex-col gap-5 w-full">
          <SelectField
            label="Source of Funds" placeholder="Select source of funds"
            value={sourceOfFunds} onChange={setSourceOfFunds}
            options={["Employment / Salary","Business Income","Investments","Inheritance / Gift","Rental Income","Pension / Retirement","Other"]}
          />
          <TextField
            label="Most Recent Occupation" placeholder="e.g. Software Engineer"
            value={occupation} onChange={setOccupation}
          />
          <SelectField
            label="Employment Status" placeholder="Select employment status"
            value={employmentStatus} onChange={setEmploymentStatus}
            options={["Employed (Full-time)","Employed (Part-time)","Self-employed","Business Owner","Retired","Student","Unemployed"]}
          />
        </div>
